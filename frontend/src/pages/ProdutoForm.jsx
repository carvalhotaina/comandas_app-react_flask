...
const ProdutoForm = () => {
  ...
  return (
    <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ backgroundColor: '#fff8f0', padding: 3, borderRadius: 3, maxWidth: 600, margin: 'auto', mt: 4 }}>
      <Toolbar sx={{ mb: 3 }}>
        <Typography variant="h5" color="secondary">Cadastro de Produto</Typography>
      </Toolbar>
